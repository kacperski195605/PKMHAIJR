...
public interface ProductRepository extends CrudRepository<Product, Integer> {
    ...
    @Query(nativeQuery = true, value= "Select * from PRODUCTS p where p.title like %:title% and p.genre = :genre")
    ArrayList<Product> findProducts(@Param("title") String title, @Param("genre")Genre genre);
